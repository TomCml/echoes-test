...
from app.models.enums import SpellType
...
class Spell(Base):
    ...
    spell_type = Column(Enum(SpellType, name="spell_type_enum"), default=SpellType.BASIC)
    damage_type = Column(Enum(DamageType, name="damage_type_enum"), nullable=False)
